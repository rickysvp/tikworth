...
const en = {
  ...
  home: {
    ...
    pricing: {
      ...
      compareTitle: 'Why TokValue?',
      compareSubtitle: 'How we stack up against manual valuation and other tools',
      features: {
      ...
      plans: [
        {
          id: 'pack1',
          name: 'Starter',
          desc: 'For creators just getting started with brand deals',
          highlight: false,
          includes: ['scoring', 'brandDeal', 'report', 'history'],
        },
        {
          id: 'pack6',
          name: 'Popular',
          desc: 'Best value for growing creators and agencies',
          highlight: true,
          badge: 'Best Value',
          includes: ['scoring', 'brandDeal', 'monetization', 'report', 'benchmark', 'history', 'growth', 'commerce', 'risk'],
        },
        {
          id: 'pack30',
          name: 'Pro',
          desc: 'For agencies, MCNs, and serious creators',
          highlight: false,
          includes: ['scoring', 'brandDeal', 'monetization', 'report', 'benchmark', 'history', 'growth', 'commerce', 'risk', 'ip', 'content', 'api'],
        },
      ],
    },
    faq: {
